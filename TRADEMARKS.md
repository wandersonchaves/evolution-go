...
Evolution Foundation. The "evolution-go" wordmark and the Evolution Go
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of Evolution Go trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
Evolution Go visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "Evolution Go";
(b) the official logo and wordmark: the "evolution-go" wordmark and any
    associated icon in neon green;
(c) the copyright line "© 2026 Evolution Foundation"; and
(d) any materials that implement or express the Evolution Go official look
...
2.1. You may truthfully refer to Evolution Go to describe that your software
...
Evolution Go that include Evolution Go brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use Evolution Go marks in nominative ways, such as
"based on Evolution Go", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "Evolution Go";
(b) Official logo and wordmark: the "evolution-go" wordmark and any associated icon;
...
Evolution Go brand assets.** If you distribute or publicly host any version
of the user interface that uses Evolution Go brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove Evolution Go brand assets.**
...
(a) remove and replace all Evolution Go trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from Evolution Go.

4.3. **No endorsement.**
You may not use Evolution Go trademarks or brand assets in a way that
...
Any violation of this policy terminates your permission to use Evolution Go
brand assets. You must promptly cease use and remove Evolution Go trademarks
